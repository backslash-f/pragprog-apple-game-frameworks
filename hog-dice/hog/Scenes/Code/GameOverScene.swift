...
class GameOverScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        // Report score
        GameKitHelper.shared.reportScore(
            score: GameData.shared.wins,
            forLeaderboardID: GameKitHelper.leaderBoardIDMostWins
        )

        // Report achievements.
        GameKitHelper.shared.reportAchievements(
            achievements: [AchievementsHelper.firstWinAchievement(didWin: isWinner)]
        )
    }
